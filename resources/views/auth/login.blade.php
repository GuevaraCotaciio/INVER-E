    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 bg-dark text-white" style="border-radius: 1rem;" >
            <div class="card-body p-md-3 mx-md-2">
                ...
                <div class="text-center"> <h2 class="mt-1 mb-3 pb-1">Ingresa</h2> </div>
                <form method="POST" action="{{ route('login') }}">
                @csrf
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form1">* Usuario</label>
                        <input type="email" id="form1"  name="email"  class="form-control @error('email') is-invalid @enderror" placeholder="E-mail"  value="{{ old('email') }}" required autocomplete="email" autofocus/>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="password" id="form2" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="********" />
                    ...
                    <div class="row  text-center ">
                        <div class="mb-4">
                            <button class="col-6 btn btn-primary btn-lg" type="submit">Aceptar</button>
                        </div>
                ...
                <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button type="submit" class="btn btn-outline-danger" > <a href="{{ route('register') }}">Crear Cuenta</a> </button>
                </div>
            </div>
        </div>
