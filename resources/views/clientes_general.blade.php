    ...
    <div class="col-lg-12">
      ...
      <div class="row col-sm-12   align-items-center justify-content-center">
           ...
           <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                <div style="border-radius: 50%!important; background-color:#e0f8e9; width: 64px; height: 64px; font-size: 32px;" class=" d-flex align-items-center justify-content-center">
                  <a href="{{ route('clientes_general') }}"><i class="bi bi-person-plus" style="color: #2eca6a;"></i></a>
                </div>
                <div class="ps-2">
                  <h6>145</h6>
        ...
        <div class="col-sm-3 bg-white ms-4" >
           <div class="card-body">
              <a class=" nav-link" href="{{ route('informes.clientes') }}"><h5 class="card-title">Informes clientes</h5></a>
              <div class="d-flex align-items-center">
                <div  style="border-radius: 50%!important; background-color:#e0f8e9; width: 64px; height: 64px; font-size: 32px;" class=" d-flex align-items-center justify-content-center">
                  <a href="{{ route('informes.clientes') }}"><i class="bi bi-file-earmark-bar-graph" style="color: #2eca6a;"></i></a>
                </div>
                <div class="ps-2">
                  <h6>145</h6>
                  <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>
